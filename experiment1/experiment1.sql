...
-- DCL
CREATE ROLE reporting_user1 
LOGIN 
PASSWORD
'user123';

GRANT SELECT ON department TO reporting_user1;
REVOKE SELECT ON department FROM reporting_user1;
GRANT SELECT ON project TO reporting_user1;
REVOKE CREATE ON SCHEMA PUBLIC FROM reporting_user1; 
